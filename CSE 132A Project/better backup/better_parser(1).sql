...
BEGIN
	...
	fetch next from curs1 into @Order_ID, @Order_Product_ID, @Order_Date, @Order_Priority, @Order_Quantity, @Sales, @Discount, @Ship_Mode, @Profit, @Unit_Price, @Shipping_Cost, @Customer_Name, @Province, @Region, @Customer_Segment, @Product_Category, @Product_Sub_Category, @Product_Name, @Product_Container, @Ship_Date
